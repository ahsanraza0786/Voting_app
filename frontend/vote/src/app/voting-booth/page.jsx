...
function VotingBoothInner() {
  ...
  const handleVote = () => setShowConfirmation(true);
        ...
        <div className="success-content">
          ...
          <div className="flex flex-col gap-4 mt-6">
            ...
            <button
              ...
              onClick={() =>
                (window.location.href = `/results?electionId=${currentElection._id}`)
              }
            >
              View Results
            </button>
      ...
      >
        ...
        <div className="election-meta">
          ...
          <span className="deadline">
            Voting ends: {currentElection.endDate}
          </span>
        </div>
      </motion.div>
      ...
      <div className="voting-area">
        ...
        <div className="voting-actions">
          ...
          <button
            ...
            style={{ background: "#1e40af" }}
            onClick={() =>
              (window.location.href = `/voting-booth/results?electionId=${currentElection._id}`)
            }
          >
            View Results
          </button>
        ...
        <div className="modal-backdrop">
          ...
          >
            ...
            <div className="selected-candidate">
              <h3>
                {
                  currentElection.candidates.find(
            ...
            <p className="warning">
              Note: This action cannot be undone. Your vote is final once
              submitted.
            </p>
...
export default function VotingBooth() {
  return (
    <Suspense fallback={<div>Loading voting booth...</div>}>
      <VotingBoothInner />
    </Suspense>
  );
}
